...
const homeLinkClassName = cn(
  'font-mono text-sm inline-flex items-center justify-center py-2 px-5 rounded-md',
    ...
    <div data-not-found className="bg-background">
      ...
      >
        <div className="w-full max-w-xl rounded-lg bg-surface-1 p-[15px] md:p-8">
          <p className="font-mono text-sm text-text-muted mb-3">404</p>
          <h1
            id="not-found-heading"
            className="font-sans text-2xl md:text-3xl font-medium text-text mb-3"
          >
            this page got lost in the kitchen
          </h1>
          <p className="font-sans text-base text-text-subtle leading-relaxed mb-8">
